...
"""
Object tracking consiste en detectar y seguir un objeto en un video. Ahora vamos a usar el algoritmo de camshift.
Hay que adaptar la ventana para que vaya siguiendo bien el objeto.
"""
